...
part1 = 'export default function DigitalTwinMap'
part2 = '      {/* Controls to traverse the digital twin space */}'
...
usage_code = '''{/* Technician Dispatch Routes for active faults */}
...
if part1 in content and part2 in content:
    content = content.replace(part1, component_code + part1)
    content = content.replace(part2, usage_code + part2)
