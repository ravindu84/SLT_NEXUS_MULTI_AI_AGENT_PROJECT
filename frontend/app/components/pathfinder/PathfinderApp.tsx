...
export default function App({ onBack }: { onBack?: () => void }) {
  ...
  useEffect(() => {
    ...
    setNodes(prev => {
      ...
      fetch('/mocks/report/cable-theft-alarm', {
        method: 'POST',
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 items-stretch" id="bento-dashboard-decks">
          ...
          <div className="flex flex-col gap-4" id="bento-left-column">
            ...
            <div className="relative overflow-hidden bg-[rgba(15,23,42,0.6)] border border-[rgba(56,189,248,0.2)] rounded-xl p-4 flex flex-col before:absolute before:top-0 before:left-0 before:w-full before:h-[2px] before:bg-gradient-to-r before:from-transparent before:via-[#38bdf8] before:to-transparent before:opacity-50 min-h-[380px] flex-1">
              ...
              <div className="flex-1 flex flex-col overflow-y-auto space-y-1.5 font-mono text-[11px] pr-1" id="directory-scroller-box">
                {filteredNodes.length === 0 ? (
                  <div className="text-center py-6 text-slate-500 text-xs italic flex-1">
                  ...
                  {/* End of list spacer/filler to elegantly consume remaining box height */}
                  <div className="flex-1 flex flex-col items-center justify-center opacity-[0.15] py-8 min-h-[120px] pointer-events-none mt-2">
                    <Layers className="w-8 h-8 mb-2 text-slate-400" />
                    <span className="text-[9px] tracking-[0.2em] font-bold text-slate-400">END OF DIRECTORY</span>
                  </div>
                </>
                )}
              </div>
              ...
              <AnimatePresence initial={false}>
                {!isDashboardCollapsed && (
                  ...
                  >
                    ...
                    <div className="flex flex-col gap-2.5 bg-slate-950/45 border border-slate-800/60 px-3 py-2.5 rounded-lg text-[10px] font-mono text-slate-300">
                      ...
                      <div className="grid grid-cols-3 gap-1.5 w-full">
                        <button
                          ...
                          className={`px-2 py-1.5 rounded text-[9px] font-bold uppercase transition-all cursor-pointer flex justify-center items-center gap-1 border ${
                        ...
                        >
                          <Clock className="w-3 h-3 text-amber-400 hidden xl:block" />
                          <span>SHORTEST</span>
                        </button>
                        <button
                        ...
                        <button
                          ...
                          title="Organize alarms grouped by network asset groups"
                        >
                          <span>BY ASSET</span>
                        </button>
                      </div>
